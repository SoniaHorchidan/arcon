    ...
    let mut pipeline = Pipeline::default()
        ...
        .operator(OperatorBuilder {
            constructor: Arc::new(|backend| {
                ...
                WindowAssigner::sliding(function, backend, Time::seconds(1000), Time::seconds(500), Time::seconds(0), false)
            }),
        ...
        .operator(OperatorBuilder {
            constructor: Arc::new(|backend| {
                ...
                WindowAssigner::tumbling(function, backend, Time::seconds(2000), Time::seconds(0), false)
            }),
            conf: Default::default(),
        })
        .to_console()
